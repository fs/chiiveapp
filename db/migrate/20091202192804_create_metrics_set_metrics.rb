class CreateMetricsSetMetrics < ActiveRecord::Migration
  def self.up
    create_table :metrics_set_metrics do |t|
    ...
    add_column :groups, :metrics_id, :integer

  end

  def self.down
    drop_table :metrics_set_metrics
    remove_column :groups, :metrics_id
  end
end
